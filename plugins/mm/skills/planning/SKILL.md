...
`{docs_root}/.superpowers-plans/` is created by the implementation handoff stage and must be gitignored. It contains ephemeral implementation plans generated by superpowers and is not committed to the repository.
