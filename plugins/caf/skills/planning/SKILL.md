...
`.eng-docs/.friction-logs/` is created by the `caf:friction-log` skill and must be gitignored. It contains friction log sessions and is not committed to the repository.
